<?php
  ...
  class Utility
  {
      ...
      public static function status($status, $id)
      {
          switch ($status) {
              ...
              case "n":
                  ...
                  $display = '<a data-set=\'{"option":[{"doAction": 1,"page":"resendNotification", "resendNotification": 1,"processItem":1, "id":' . $id . '}], "label":"' . Lang::$word->M_SUB6 . '", "url":"helper.php", "parent":"#user_' . $id . '", "action":"highlite","modalclass":"tiny"}\' class="wojo small primary label addAction">' . $icon . Lang::$word->INACTIVE . '</a>';
                  break;
      ...
      public static function getColumnSize()
      {
		  ...
		  $colorArray = array(40, 60, 50, 50, 60, 40, 50, 50, 100, 50, 50);
		  $colorCounter++;
