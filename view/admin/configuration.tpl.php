<?php
   ...
   * @copyright 2018
   * @version $Id: configuration.tpl.php, v1.00 2018-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
  ...
  <div class="wojo segment form">
    ...
    <div class="wojo fields">
      ...
      <div class="field five wide">
        ...
        <div class="wojo half-top-padding">
          <div class="wojo small checkbox">
            <input name="dellogop" type="checkbox" value="1" id="plogo">
            <label for="plogo"><?php echo Lang::$word->CG_LOGODEL;?></label>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="wojo fields">
      ...
      <div class="field five wide">
        ...
        <div class="wojo checkbox radio fitted inline">
          ...
          <label for="eucookie0"><?php echo Lang::$word->YES;?></label>
        </div>
        <div class="wojo checkbox radio fitted inline">
  ...
  <div class="wojo segment form">
    <div class="wojo fields">
      ...
      <div class="field">
        ...
        <div class="wojo checkbox radio fitted inline">
          <input name="auto_verify" type="radio" value="1" id="reg_verify_1" <?php Validator::getChecked($this->data->auto_verify, 1); ?>>
          <label for="reg_verify_1"><?php echo Lang::$word->YES;?></label>
        </div>
        <div class="wojo checkbox radio fitted inline">
          <input name="auto_verify" type="radio" value="0" id="reg_verify_0" <?php Validator::getChecked($this->data->auto_verify, 0); ?>>
          <label for="reg_verify_0"><?php echo Lang::$word->NO;?></label>
        </div>
      </div>
      <div class="field">
    ...
    <div class="wojo fields">
      ...
      <div class="field">
        ...
        <div class="wojo right labeled input">
          ...
          <span class="wojo basic label">min.</span>
        </div>
      </div>
      <div class="field">
    ...
    <div class="wojo fields">
      ...
      <div class="five wide field">
        ...
        <div class="row">
          ...
          <div class="column">
            <div class="wojo fluid right icon input" data-timepicker="true">
        ...
        <div class="row half-horizontal-gutters">
          <div class="column">
            <div class="wojo right fluid labeled input">
              ...
              <span class="wojo basic label">px</span>
            </div>
          </div>
          <div class="column">
            <div class="wojo right fluid labeled input">
    ...
    <div class="wojo fields">
      ...
      <div class="field five wide">
        ...
        <div class="wojo right fluid labeled input ">
          ...
          <span class="wojo basic label">mb</span>
        </div>
      </div>
    </div>
    <div class="wojo fields">
