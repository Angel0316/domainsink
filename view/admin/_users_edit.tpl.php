<?php
   ...
   * @copyright 2016
   * @version $Id: _users_edit.tpl.php, v1.00 2016-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
  ...
  <div class="wojo segment form">
    ...
    <div class="wojo fields">
      <div class="field">
        ...
        <select name="modaccess[]" class="wojo fluid multiple dropdown selection" multiple>
      ...
      <div class="field">
        ...
        <select name="plugaccess[]" class="wojo fluid multiple dropdown selection" multiple>
