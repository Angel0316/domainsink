<?php
   ...
   * @copyright 2018
   * @version $Id: trash.tpl.php, v1.00 2018-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="row half-gutters align-middle">
  ...
  <?php if($this->data):?>
  <div class="column shrink mobile-100 phone-100"> <a data-set='{"option":[{"delete": "trashAll","title": "<?php echo Lang::$word->TRS_TEMPTY;?>"}],"action":"delete","parent":"#self","redirect":"<?php echo Url::url(Router::$path);?>"}' class="action wojo negative button"><?php echo Lang::$word->TRS_TEMPTY;?> </a> </div>
  <?php endif;?>
</div>
<?php if(!$this->data):?>
