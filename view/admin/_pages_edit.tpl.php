<?php
   ...
   * @copyright 2016
   * @version $Id: _pages_list.tpl.php, v1.00 2016-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
        ...
        <div class="wojo fields">
          ...
          <div class="field">
            ...
            <div class="wojo fluid right action input">
              ...
              <div class="wojo basic small simple button removebg">
          ...
          <div class="field">
            <div class="row half-gutters">
              <div class="columns shrink">
                <a class="wojo white button" href="<?php echo Url::url("/admin/builder/" . $lang->abbr, $this->data->id);?>"><i class="icon sliders horizontal"></i>
        ...
        <div class="columns screen-50 mobile-100">
          <div class="wojo block fields">
            <div class="field">
              ...
              <select name="access" id="access_id" data-id="<?php echo $this->data->id;?>" class="wojo fluid dropdown access_id">
          ...
          <div class="wojo block fields">
            <div class="field">
              ...
              <div id="membership">
                ...
                <?php else:?>
                <select name="membership_id[]" class="wojo fluid selection dropdown" multiple>
