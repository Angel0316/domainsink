  ...
  <div class="wojo segment form">
    ...
    <div class="wojo fields">
      <div class="field five wide">
        ...
        <div class="wojo right fluid input">
...
<div class="wojo segment">
  <div class="wojo small divided relaxed flex list align-middle" id="editable">
    ...
    <div class="item">
      <div class="content"><span class="wojo tiny basic label"><?php echo $row->sorting;?></span>
        <a href="<?php echo Url::url(Router::$path, "edit/" . $row->id);?>" class="inverted"><?php echo $row->name;?></a>
      </div>
      <div class="content shrink"><span class="wojo small label"><?php echo $row->abbr;?></span></div>
    </div>
    <?php endforeach;?>
  </div>
</div>
