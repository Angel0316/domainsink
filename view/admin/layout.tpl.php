<?php
   ...
   * @copyright 2018
   * @version $Id: layout.tpl.php, v1.00 2018-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="row half-gutters align-middle">
  ...
  <div class="columns shrink content-right mobile-100 mobile-content-left">
    ...
    <select name="mod_id" class="wojo fluid small dropdown">
...
<div class="wojo<?php echo ($this->layoutlist->page or $this->layoutlist->mod) ? null : ' readonly';?>">
  <div class="row gutters">
    <div class="column">
      <div class="wojo attached segment">
        <a data-section="top" class="wojo small top left simple icon attached button pEdit"><i class="icon disabled apps"></i></a>
  ...
  <div class="row gutters">
    <div class="column screen-40">
      <div class="wojo attached segment"><a data-section="left" class="wojo small top right simple basic attached button pAdd"><?php echo Lang::$word->LMG_LEFT;?>
          <i class="icon small chevron down"></i></a>
    ...
    <div class="column">
      <div class="wojo attached segment secondary"><span class="wojo small simple fluid button"><?php echo Lang::$word->LMG_MAIN;?></span></div>
    </div>
    <div class="column screen-40">
      <div class="wojo attached segment"><a data-section="right" class="wojo small top right simple basic attached button pAdd"><?php echo Lang::$word->LMG_RIGHT;?>
          <i class="icon small chevron down"></i></a>
  ...
  <div class="row">
    <div class="column">
      <div class="wojo attached segment">
        <a data-section="bottom" class="wojo small top left simple icon attached button pEdit"><i class="icon disabled apps"></i></a>
