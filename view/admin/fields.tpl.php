<?php
   ...
   * @copyright 2018
   * @version $Id: fields.tpl.php, v1.00 2018-08-10 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
    ...
    <div class="content">
      ...
      <div id="lang_<?php echo $lang->abbr;?>" class="wojo tab item">
        <div class="wojo fields">
          <div class="field five wide">
            ...
            <div class="wojo fluid huge input">
      ...
      <div class="wojo fields">
        <div class="field five wide">
          ...
          <select name="section" class="wojo fluid dropdown">
...
<div class="row half-gutters align-middle">
  ...
  <div class="column shrink mobile-100 phone-100">
    <a href="<?php echo Url::url(Router::$path, "new/");?>" class="wojo secondary button"><i class="icon plus alt"></i><?php echo Lang::$word->CF_ADD;?></a>
  </div>
</div>
<?php if(!$this->data):?>
...
<div class="row screen-block-3 tablet-block-2 mobile-block-1 phone-block-1 gutters align-center" id="sortable">
  ...
  <div class="column" id="item_<?php echo $row->id;?>" data-id="<?php echo $row->id;?>">
    <div class="wojo boxed attached segment">
      <div class="wojo simple small icon  top left attached button handle"><i class="icon reorder link"></i></div>
      <h5 class="content-center"><a href="<?php echo Url::url(Router::$path, "edit/" . $row->id);?>" class="inverted"><?php echo $row->{'title' . Lang::$lang};?></a>
      </h5>
      <p class="wojo small text content-center">[<?php echo $row->section;?>]</p>
