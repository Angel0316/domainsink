        ...
        $(document).on('click', '.addAction', function() {
            ...
            $.get(url, dataset.option[0], function(data) {
				if(dataset.buttons !== false) {
					actions += '' +
                    '<div class="actions">' +
					'<div class="wojo simple small cancel button">' + config.lang.canBtn + '</div>' +
        ...
        $(document).on('click', 'a.action', function() {
            ...
            switch (dataset.action) {
                case "trash":
                    ...
                    subtext = '<span class="wojo semi text">' + config.lang.delMsg8 + '</span>';
                ...
                case "delete":
                    ...
                    subtext = '<span class="wojo semi text">' + config.lang.delMsg2 + '</span>';
            ...
            $('<div class="wojo tiny modal">' +
                ...
                '<div class="actions">' +
                '<div class="wojo simple small cancel button">' + config.lang.canBtn + '</div>' +
                '<div class="wojo ok small primary button">' + btnLabel + '</div>' +
                '</div>' +
