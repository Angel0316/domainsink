        ...
        $(".pAdd").on('click', function() {
            ...
            $.get(config.url + "/helper.php", data, function(json) {
                ...
                $(".button.insert").on('click', function() {
                    var items = '';
                    var allitems = [];
                    var section = $('.popplug .wojo.list').data('section');
                    $('.popplug .wojo.list div.active').each(function() {
                        var id = $(this).data('id');
                        var text = $(this).text();
                    ...
                    $('.popplug .wojo.list div.active').remove();
                });
                $(".popplug .wojo.list").on('click', 'div', function() {
