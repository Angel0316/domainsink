<?php
   ...
   * @copyright 2018
   * @version $Id: gateways.tpl.php, v1.00 2018-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<form method="post" id="wojo_form" name="wojo_form">
  ...
  <div class="content-center">
    <a href="<?php echo Url::url("/admin/gateways");?>" class="wojo simple small button"><?php echo Lang::$word->CANCEL;?></a>
      ...
      <div class="basic footer">
        <div class="row align-middle half-vertical-gutters no-gutters">
          ...
          <div class="columns shrink">
            <div class="wojo fitted toggle checkbox is_dimmable" data-set='{"option":[{"quickStatus": 1,"id":<?php echo $row->id;?>,"status":"gateway"}],"parent":"#item_<?php echo $row->id;?>"}'>
