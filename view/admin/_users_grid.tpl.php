<?php
   ...
   * @copyright 2018
   * @version $Id: _users_grid.tpl.php, v1.00 2018-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="row horizontal-gutters align-bottom">
  ...
  <div class="columns shrink">
    <a href="<?php echo Url::url("/admin/users");?>" class="wojo primary icon button"><i class="icon unordered list"></i></a>
    <a class="wojo basic disabled icon button"><i class="icon grid"></i></a>
...
<div class="row double-gutters phone-block-1 mobile-block-1 tablet-block-2 screen-block-4">
  ...
  <div class="column" id="item_<?php echo $row->id;?>">
    <div class="wojo card attached">
      <div class="wojo simple small top left attached button"><?php echo Utility::userType($row->type);?></div>
      <div class="wojo simple small top right attached button"><?php echo Utility::status($row->active, $row->id);?></div>
      ...
      <div class="content">
        <div class="wojo flex list align-middle">
          <div class="item">
