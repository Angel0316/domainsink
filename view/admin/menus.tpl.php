<?php
   ...
   * @copyright 2018
   * @version $Id: menus.tpl.php, v1.00 2018-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<form method="post" id="wojo_form" name="wojo_form">
    ...
    <div class="content">
      ...
      <div class="wojo fields">
        ...
        <div class="field" id="contentid" style="display:<?php echo ($this->data->content_type != "web") ? 'block' : 'none';?>">
          ...
          <select name="<?php echo ($this->data->content_type == "page" ? "page_id" : ($this->data->content_type == "module" ? "mod_id" : "web_id"));?>" id="page_id" class="wojo fluid dropdown">
      ...
      <div id="webid" style="display:<?php echo ($this->data->content_type == "web") ? 'block' : 'none';?>">
        <div class="wojo fields">
          ...
          <div class="field">
            ...
            <select name="target" class="wojo fluid dropdown">
  ...
  <div class="content-center">
    <a href="<?php echo Url::url("/admin/menus");?>" class="wojo simple small button"><?php echo Lang::$word->CANCEL;?></a>
    <button type="button" data-action="processMenu" name="dosubmit" class="wojo primary button"><?php echo Lang::$word->MEN_SUB4;?></button>
  </div>
...
<form method="post" id="wojo_form" name="wojo_form">
    ...
    <div class="content">
      ...
      <div class="wojo fields">
        <div class="field">
          ...
          <select id="parent_id" name="parent_id" class="wojo fluid dropdown">
        ...
        <div class="field">
          ...
          <select name="content_type" id="contenttype" class="wojo fluid dropdown">
      ...
      <div class="wojo fields">
        ...
        <div class="field" id="contentid">
          <label><?php echo Lang::$word->MEN_SUB2;?></label>
          <select name="content_id" id="page_id" class="wojo fluid dropdown">
  ...
  <div class="content-center">
    <button type="button" data-action="processMenu" name="dosubmit" class="wojo primary button"><?php echo Lang::$word->MEN_SUB3;?></button>
  </div>
</form>
<?php break;?>
<?php endswitch;?>
