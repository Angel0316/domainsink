<?php
   ...
   * @copyright 2018
   * @version $Id: _users_history.tpl.php, v1.00 2018-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="wojo segment">
  <div id="legend" class="wojo small horizontal list align-right">
    <div class="item"><span class="wojo tiny empty circular label">
      </span></div>
  </div>
  <div id="payment_chart" style="height:300px;"></div>
</div>
<div class="row gutters">
  <div class="column content-right"><a href="<?php echo ADMINVIEW . '/helper.php?exportUserPayments&amp;id=' . $this->data->id;?>" class="wojo secondary button"><i class="icon wysiwyg table"></i><?php echo Lang::$word->EXPORT;?></a>
  </div>
</div>
<div class="wojo card">
  <ul class="wojo fluid wide tabs">
  ...
  <div id="pay" class="wojo tab item">
    ...
    <div class="wojo padding">
    <a class="wojo small primary passive button"><?php echo Lang::$word->TRX_TOTAMT;?>
