<?php
   ...
   * @copyright 2016
   * @version $Id: routes.php, v1.00 2016-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
  ...
  //Domsale
  $router->mount('/domsale', function() use ($router, $tpl) {
	  $router->get('/', '/view/admin/plugins_/domsale/@domsale@AdminIndex');
  });
