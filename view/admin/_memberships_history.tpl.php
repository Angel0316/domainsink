<?php
   ...
   * @copyright 2018
   * @version $Id: _memberships_history.tpl.php, v1.00 2018-07-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="row">
  ...
  <div class="column shrink"><a href="<?php echo ADMINVIEW . '/helper.php?exportMembershipPayments&amp;id=' . $this->data->id;?>" class="wojo secondary button"><i class="icon wysiwyg table"></i><?php echo Lang::$word->EXPORT;?></a>
  </div>
</div>
