...
<div id="builderHeader">
  <div class="row align-middle horizontal-gutters">
    ...
    <div class="columns">
      <h4 class="wojo white text"><?php echo $this->data->{'title' . Lang::$lang};?></h4>
    </div>
    <div class="column shrink reswitch">
      <a data-mode="screen" class="wojo transparent icon button action"><i class="icon primary desktop"></i></a>
      <a data-mode="tablet" class="wojo transparent icon button action"><i class="icon laptop"></i></a>
      <a data-mode="phone" class="wojo transparent icon button action"><i class="icon smartphone"></i></a>
    </div>
    <?php if(count($this->langlist) > 1):?>
    <div class="column shrink horizontal-padding">
      <a data-dropdown="#dropdown-langMenu" class="wojo transparent icon button">
        <i class="icon flag"></i>
      </a>
    ...
    <div class="column shrink">
      ...
      <a id="saveAll" class="wojo secondary icon button">
