...
<div id="style-helper" class="transition hidden">
  ...
  <div class="wojo form" id="seditor">
      ...
      <div class="content">
        <div class="wojo block fields">
          ...
          <div class="field">
            ...
            <div id="borderColor" class="wojo colorpicker"></div>
          </div>
        </div>
      </div>
    </article>
    <article class="wojo accordion">
      ...
      <div class="content">
        <div class="wojo half fields content-center">
        ...
        <div class="wojo block fields">
          ...
          <div class="field">
            ...
            <div id="shadowColor" class="wojo colorpicker"></div>
          </div>
        </div>
      </div>
    </article>
        ...
        <div id="bgColor" class="wojo tab active">
          <div class="wojo block fields">
            <div class="field">
              ...
              <div id="backgroundColor" class="wojo colorpicker"></div>
            </div>
          </div>
        </div>
        <div id="bgGradient" class="wojo tab">
          <div class="wojo block fields">
            <div class="field">
              ...
              <div id="gradColorStart" class="wojo colorpicker"></div>
            </div>
            <div class="field">
              <label>Stop Color</label>
              <div id="gradColorStop" class="wojo colorpicker"></div>
            </div>
            <div class="field">
