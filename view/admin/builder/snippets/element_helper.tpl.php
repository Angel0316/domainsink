...
<div id="element-helper" class="transition hidden">
  ...
  <div class="wojo form wrapper" id="eleditor">
    <?php /*?>  <a id="elementRestore" class="wojo small circular icon button" data-tooltip="Restore" data-position="left center"><i class="icon undo"></i></a>
<?php */?>
    <div data-field="elementButton" class="eltype">
      <h4>Edit Button</h4>
      <div class="wojo block half fields">
        <div class="field">
        ...
        <div class="field">
          ...
          <div class="content-center">
            <button name="buttonSize" type="button" class="wojo small basic button" data-value="mini">Mini</button>
            <button name="buttonSize" type="button" class="wojo small basic button" data-value="small">Small</button>
            <button name="buttonSize" type="button" class="wojo small basic button" data-value="">Default</button>
            <button name="buttonSize" type="button" class="wojo small basic button" data-value="big">Big</button>
          </div>
        </div>
        <div class="field">
      ...
      <div class="wojo half fields">
        <div class="field">
          <label>Button Style</label>
          <button name="buttonStyle" type="button" class="wojo small basic button" data-value="">&nbsp;</button>
          <button name="buttonStyle" type="button" class="wojo small basic button rounded" data-value="rounded">&nbsp;</button>
          <button name="buttonStyle" type="button" class="wojo basic icon button circular" data-value="circular"></button>
        </div>
        <div class="field">
          <label>Button Width</label>
          <button name="buttonWidth" type="button" class="wojo small basic button" data-tooltip="Auto" data-value="">A</button>
          <button name="buttonWidth" type="button" class="wojo small basic button" data-tooltip="Fluid" data-value="fluid">F</button>
        </div>
      </div>
      <div class="wojo half fields">
        <div class="field">
          <label>Icon Spin</label>
          <button name="buttonSpin" type="button" class="wojo small basic icon button" data-value="1"><i class="icon check"></i></button>
          <button name="buttonSpin" type="button" class="wojo small basic icon button" data-value="0"><i class="icon close"></i></button>
        </div>
        <div class="field">
          <label>Icon Position</label>
          <button name="buttonIcon" type="button" class="wojo small basic icon button" data-value="">
          <i class="icon chevron left"></i>
          </button>
          <button name="buttonIcon" type="button" class="wojo small basic icon button" data-value="right">
      ...
      <div class="wojo block half fields">
        <div class="field">
          ...
          <button name="buttonType" type="button" class="wojo small basic button" data-value="a">Link</button>
          <button name="buttonType" type="button" class="wojo small basic button active" data-value="button">Button</button>
        </div>
      </div>
    </div>
    <div data-field="elementLink" class="eltype">
      ...
      <div class="wojo block half fields">
        <div class="field">
          <label>Link</label>
          <div class="wojo small fluid action right input">
            <input id="elementLink"  placeholder="http://" value="" type="text">
            <div class="wojo white icon button" data-dropdown="#linkDrop">
