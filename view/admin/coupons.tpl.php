...
<form method="post" id="wojo_form" name="wojo_form">
      ...
      <div class="wojo fields">
        <div class="field five wide">
          <label><?php echo Lang::$word->DC_SUB3;?>
            <i class="icon asterisk"></i></label>
          <select name="membership_id[]" class="wojo fluid dropdown" multiple>
            <option value="">-/-</option>
        ...
        <div class="field five wide">
          ...
          <div class="wojo fluid input">
            ...
            <select class="wojo small fluid dropdown" name="type">
  ...
  <div class="content-center">
    <a href="<?php echo Url::url("/admin/coupons");?>" class="wojo simple small button"><?php echo Lang::$word->CANCEL;?></a>
      ...
      <div class="wojo fields">
        ...
        <div class="field five wide">
          ...
          <div class="wojo fluid input">
            ...
            <select class="wojo fluid dropdown" name="type">
...
<div class="row half-gutters align-middle">
  ...
  <div class="column shrink mobile-100 phone-100">
    <a href="<?php echo Url::url(Router::$path, "new/");?>" class="wojo secondary button"><i class="icon plus alt"></i><?php echo Lang::$word->DC_SUB1;?></a>
  </div>
</div>
<?php if(!$this->data):?>
  ...
  <div class="column" id="item_<?php echo $row->id;?>">
    <div class="wojo segment">
      ...
      <div class="row align-middle half-vertical-gutters no-gutters">
        <div class="columns">
          <a data-set='{"option":[{"trash": "trashCoupon","title": "<?php echo Validator::sanitize($row->title, "chars");?>","id":<?php echo $row->id;?>}],"action":"trash","parent":"#item_<?php echo $row->id;?>"}' class="wojo icon negative button action">
            <i class="icon trash"></i>
          </a>
        </div>
        <div class="columns shrink">
          <div class="wojo checkbox fitted toggle is_dimmable" data-set='{"option":[{"quickStatus": 1,"id":<?php echo $row->id;?>,"status":"coupon"}],"parent":"#cpn_<?php echo $row->id;?>"}' >
