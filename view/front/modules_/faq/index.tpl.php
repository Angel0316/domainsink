...
<div class="row gutters">
  <div class="columns relative screen-20 tablet-20 mobile-hide phone-hide">
    <?php if($cats):?>
    <div class="wojo sticky" data-sticky='{"pushing": false, "context":"#context","observeChanges":true,"offset":100,"bottomOffset":10}'>
      <div class="wojo primary basic card">
        <div class="padding">
  ...
  <div class="columns screen-80 tablet-80 mobile-100 phone-100" id="context">
    ...
    <div class="wojo accordion" data-accordion-options='{"openSingle": true}' id="cat_<?php echo $cat['name'];?>">
