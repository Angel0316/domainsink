...
<?php if($data):?>
  <h2 class="wojo primary text"><?php echo $rows->title;?></h2>
  <p><?php echo $rows->description;?></p>
<div class="wojo blocks margin-top" data-wblocks='{"itemWidth":<?php echo $rows->cols;?>}'>
  ...
  <div class="item">
    <div class="wojo attached photo card">
      <div class="wDimmer dimmable image">
        <div class="wojo primary dimmer">
          <div class="content">
            <div class="center">
              <a href="<?php echo FMODULEURL . $is_watermark;?>" data-title="<?php echo $row->{'description' . Lang::$lang};?>" data-gallery="gallery" class="lightbox wojo circular white icon button">
...
<?php if($this->photos):?>
<div class="wojo-grid">
  <h2 class="wojo primary text"><?php echo $this->row->{'title' . Lang::$lang};?></h2>
  <p><?php echo $this->row->{'description' . Lang::$lang};?></p>
  <div class="wojo blocks margin-top" data-wblocks='{"itemWidth":<?php echo $this->row->cols;?>}'>
...
<div class="wojo-grid">
  <div class="wojo blocks" data-wblocks='{"itemWidth":400, "align":"center", "gapX":64, "gapY":64}'>
    ...
    <div class="item">
      <div class="wDimmer dimmable image">
        <div class="wojo primary rounded dimmer">
          <div class="content">
            <div class="center">
              <?php if($row->{'title' . Lang::$lang}):?>
              <h3 class="wojo white text"><?php echo $row->{'title' . Lang::$lang};?></h3>
              <?php endif;?>
              <?php if($row->{'description' . Lang::$lang}):?>
              <p class="wojo small white text"><?php echo $row->{'description' . Lang::$lang};?></p>
              <?php endif;?>
              <p class="half-padding">
                <a href="<?php echo Url::url("/" . $this->segments[0] . "/" . App::Core()->modname['gallery-album'], $row->{'slug' . Lang::$lang});?>" class="wojo circular white icon button">
                  <i class="icon url alt"></i>
                </a>
              </p>
