<?php
   ...
   * @copyright 2018
   * @version $Id: mod_index.tpl.php, v1.00 2018-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
      ...
      <div class="wojo-grid">
        <div class="row gutters">
          <div class="columns screen-100 tablet-100 mobile-100 phone-100 phone-content-center">
            ...
            <h1 class="wojo primary huge text"><?php echo $this->data->{'title' . Lang::$lang};?></h1>
            <?php endif;?>
            <?php if(isset($this->data->{'info' . Lang::$lang})):?>
            <p class="wojo medium thin text"><?php echo $this->data->{'info' . Lang::$lang};?></p>
            <?php endif;?>
          </div>
