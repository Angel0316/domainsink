<?php
   ...
   * @copyright 2018
   * @version $Id: _memberships.tpl.php, v1.00 2018-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="wojo-grid">
  ...
  <div id="membershipSelect" class="wojo cards screen-block-3 tablet-block-2 mobile-block-1 phone-block-1 align-center">
    ...
    <div class="card <?php echo Auth::$udata->membership_id == $row->id ? ' active' : null;?>" id="item_<?php echo $row->id;?>">
      <div class="content">
        <figure class="wojo basic image margin-bottom">
          <?php if($row->thumb):?>
        ...
        <h5 class="wojo primary text content-center">
