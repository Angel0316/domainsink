 ...
 * @copyright 2018
 * @version $Id: account.tpl.php, v1.00 2018-05-05 10:12:05 gewa Exp $
 */
if ( !defined( "_WOJO" ) )
...
-->
            <li class="item<?php if (count($this->segments) == 1) echo ' active';?>">
              <a href="<?php echo Url::url('/' . $this->url);?>">
                <i class="icon earth"></i><?php echo Lang::$word->DOMAINS;?>
              </a>
            </li>
<!--
            <li class="item">
              <a href="<?php echo Url::url('/' . $this->url, 'domadd');?>">
                <i class="icon earth"></i><?php echo Lang::$word->DOMADD;?>
              </a>
            </li>
-->
            <li class="item<?php if (in_array('settings', $this->segments)) echo ' active';?>">
              <a href="<?php echo Url::url('/' . $this->url, 'settings');?>">
                <i class="icon setting"></i><?php echo Lang::$word->SETTINGS;?>
              </a>
            </li>
  ...
  <?php break;?>
  <?php case "domadd": ?>
  <?php include_once(FPLUGPATH . 'domadd/index.tpl.php'); ?>
  <?php break;?>
  <?php case "validate": ?>
  ...
  <?php break;?>
  <?php default: ?>
  <?php include_once(FPLUGPATH . 'domlist/index.tpl.php');?>
  <?php break;?>
  <?php endswitch;?>
</main>