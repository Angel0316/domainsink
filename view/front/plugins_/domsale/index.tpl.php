...
<?php
				...
				$stmt = $dbConnection->prepare("SELECT * FROM parked_domains where forsale = :forsale and domtype = :regular order by RAND() LIMIT 5");
...
<?php
				...
				$stmt = $dbConnection->prepare("SELECT * FROM parked_domains where forsale = :forsale and domtype = :featured order by RAND() LIMIT 5");
				$stmt->bindValue(':forsale', 1);
...
<?php
				...
				$stmt = $dbConnection->prepare("SELECT * FROM parked_domains where forsale = :forsale and domtype = :premium order by RAND() LIMIT 5");
				$stmt->bindValue(':forsale', 1);
...
<?php
				...
				$stmt = $dbConnection->prepare("SELECT * FROM parked_sold order by RAND() LIMIT 5");
				$stmt->execute();
