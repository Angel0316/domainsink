...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
	...
	switch($passing)
    {
		...
		$rowsdoi = mysqli_num_rows($resdoi);	
			...
			*/
			$registrar = "DAN.com"; $reglink = "https://dan.com/buy-domain/".$domname;
...
$(function() {
    ...
    if (PullData.labels[0] == "NO DATA YET") {
        // $("#genderChart"+domid).next().css({'top':'-'+($("#refChart"+domid).height())+'px', 'left': '140px', 'display':'block'});
        $("#refChart" + domid).next().css({
            'top': '0px',
            'left': '140px',
            'display': 'block'
        });
    ...
    if (PullData2.labels[0] == "NO DATA YET") {
        // $("#geoChart"+domid).next().css({'top':'-'+($("#refChart"+domid).height())+'px', 'left': '140px', 'display':'block'});
        $("#geoChart" + domid).next().css({
            'top': '0px',
            'left': '140px',
            'display': 'block'
        });
    ...
    if (PullData3.labels[0] == "NO DATA YET") {
        // $("#browsersChart"+domid).next().css({'top':'-'+($("#browsersChart"+domid).height())+'px', 'left': '140px', 'display':'block'});
        $("#browsersChart" + domid).next().css({
            'top': '0px',
            'left': '140px',
            'display': 'block'
        });
    ...
    if (PullData4.labels[0] == "NO DATA YET") {
        // $("#osChart"+domid).next().css({'top':'-'+($("#osChart"+domid).height())+'px', 'left': '140px', 'display':'block'});
        $("#osChart" + domid).next().css({
            'top': '0px',
            'left': '140px',
            'display': 'block'
        });
    ...
    if (PullData5.labels[0] == "NO DATA YET") {
        // $("#genderChart"+domid).next().css({'top':'-'+($("#genderChart"+domid).height())+'px', 'left': '140px', 'display':'block'});
        $("#genderChart" + domid).next().css({
            'top': '0px',
            'left': '140px',
            'display': 'block'
        });
    ...
    if (PullData6.labels[0] == "NO DATA YET") {
        // $("#ageChart"+domid).next().css({'top':'-'+($("#genderChart"+domid).height())+'px', 'left': '140px', 'display':'block'});
        $("#ageChart" + domid).next().css({
            'top': '0px',
            'left': '140px',
            'display': 'block'
        });
    ...
    if (PullData7.labels[0] == "NO DATA YET") {
        // $("#interestChart"+domid).next().css({'top':'-'+($("#interestChart"+domid).height())+'px', 'left': '140px', 'display':'block'});
        $("#interestChart" + domid).next().css({
            'top': '0px',
            'left': '140px',
            'display': 'block'
        });
...
<div class="container-fluids">
    ...
    <div class="row align-center" style="margin-right: 0">
        ...
        <div style="width: 100%">
            ...
            <div class="row">
                ...
                <div style="flex: 0 0 50%; max-width: 50%;">
                    ...
                    <div style="padding:3px; position:relative;">
                        ...
                        <img class="no_data_img" src="https://www.domainsink.com/uploads/no-data.png"
                            style="width: 50%;position: absolute; display:none; " />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div style="flex: 0 0 50%; max-width: 50%;">
                    ...
                    <div style="padding:10px; position:relative;">
                        ...
                        <canvas id="genderChart<?php echo $trimmed; ?>"></canvas>
                        <img class="no_data_img" src="https://www.domainsink.com/uploads/no-data.png"
                            style="width: 50%; position: absolute; left: 140px; " />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div style="flex: 0 0 60%; max-width: 60%;">
                    ...
                    <div style="padding:3px; position:relative;">
                        ...
                        <canvas id="refChart<?php echo $trimmed; ?>"></canvas>
                        <img class="no_data_img" src="https://www.domainsink.com/uploads/no-data.png"
                            style="width: 40%;position: absolute; display:none; " />
            ...
            else if(($screen_width >= 576) && ($screen_width < 768)) {
