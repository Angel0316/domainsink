<?php
   ...
   * @copyright 2018
   * @version $Id: master.php, v1.00 2018-12-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="wojo poll plugin segment<?php echo ($conf[0]->alt_class) ? ' ' . $conf[0]->alt_class : null;?>">
  ...
  <div class="wojo semi text half-bottom-padding content-center"><?php echo $rows->name;?></div>
  ...
  <div class="content-center half-top-padding goFront" style="display:<?php echo $voted == true ? 'none' : 'block';?>"> <a class="wojo small primary button pollVote"><?php echo Lang::$word->_PLG_PL_VOTE;?></a> <a class="wojo small semi text pollView"><?php echo Lang::$word->_PLG_PL_RESULT;?></a> </div>
  <?php endif;?>
</div>
<?php endif;?>