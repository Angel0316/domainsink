(function($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        _initBuilder: function() {
            ...
            $("#style-helper, #element-helper, #section-helper").draggable({
                handle: ".handle"
            });
            ...
            $("#elementRestore").on('click', function() {
                if ($("#tempData").children().length) {
                    var html = $("#tempData").html();
                    $activeElement.replaceWith(html);
                ...
                if (jsonObj.status === "success") {
                    switch (insertType) {
                        case "element":
                            ...
                            $("<div data-wmodule-alias=\"" + data.moduleGroup + "\" data-wmodule-id=\"" + data.moduleModule_id + "\" " +
                        ...
                        case "column":
                            $activeColumn.html("<div data-mode=\"readonly\" data-wmodule-alias=\"" + data.moduleGroup + "\" " +
                                "data-wmodule-id=\"" + data.moduleModule_id + "\">" + jsonObj.html + "</div>").attr("data-id", "temp_pc" + data.moduleModule_id);
                        ...
                        default:
                            $("<div class=\"section loading\" data-wmodule-alias=\"" + data.moduleGroup + "\" data-wmodule-id=\"" + data.moduleModule_id + "\" " +
        ...
        _insertPlugin: function(data) {
            ...
            $.get(plugin.options.url + "/helper.php", {
                ...
                page: "builderPlugin",
                id: data.pluginId,
                string: '%%' + data.pluginGroup + '|plugin|' + data.pluginPlugin_id + '|' + data.pluginId + '%%'
            }).done(function(json) {
                var jsonObj = JSON.parse(json);
                if (jsonObj.status === "success") {
                    switch (insertType) {
                        case "element":
                            ...
                            $("<div data-wplugin-alias=\"" + data.pluginGroup + "\" data-wplugin-id=\"" + data.pluginId + "\" " +
                        ...
                        case "column":
                            $activeColumn.html("<div data-mode=\"readonly\" data-wplugin-alias=\"" + data.pluginGroup + "\" " +
                                "data-wplugin-id=\"" + data.pluginId + "\">" + jsonObj.html + "</div>").attr("data-id", "temp_pc" + data.pluginId);
                        ...
                        default:
                            $("<div class=\"section loading\" data-wplugin-alias=\"" + data.pluginGroup + "\" data-wplugin-id=\"" + data.pluginId + "\" " +
		...
		_initPlugin: function(element) {
			...
			$('.wojo.blocks', element).waitForImages(true).done(function() {
				$(this).each(function() {
