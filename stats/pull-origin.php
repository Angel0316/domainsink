...
<p>
			...
			{ 
		    ?>
					<a class="wojo labeled icon button" style="box-shadow: none; background-color: rgb(255, 153, 0); color: rgb(255, 255, 255);" href="<?php echo $reglink; ?>" rel="nofollow" target="_blank">
			...
			{
			?>
					<a class="wojo labeled icon button" style="box-shadow: none; background-color: rgb(17, 179, 35); color: rgb(255, 255, 255);" href="<?php echo $reglink; ?>" rel="nofollow" target="_blank">
					  <i class="icon check" style="color: rgb(255, 255, 255);"></i>
					  BUY THIS DOMAIN<!--AT AT <?php echo $registrar; ?>-->
					</a>
...
Not convinced yet?<br><a href="https://www.domainsink.com/get-started/">Register</a>&nbsp;for free and see more details!
</div>
</p>